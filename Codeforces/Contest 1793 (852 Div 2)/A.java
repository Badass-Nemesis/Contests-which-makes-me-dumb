    ...
    public static void solve() throws IOException {
        ...
        if (n < m) {
            ...
            if (n % (m + 1) == 0) {
                long temp = (n / (m + 1)) * m * a;
                long temp2 = n * b;
                System.out.println(Math.min(tempTemp, Math.min(temp, temp2)));
            } else {
                long temp = n / (m + 1);
                long temp2 = n - temp * (m + 1);
                long temp3 = (temp * m * a) + (temp2 * b);
                long temp4 = (temp * m * a) + (temp2 * a);
                System.out.println(Math.min(tempTemp, Math.min(temp3, temp4)));
            }
        }
    }
