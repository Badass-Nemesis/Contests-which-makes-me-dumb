...
public class E {
    ...
    public static void solve() throws IOException {
        ...
        // case 1: just checking
        hm.put(1, 0); // putting 0 frequency of 1 at first
        for (int i = 0; i < n; i++) {
            if (arr[i] == 0) {
                ans1 += hm.get(1);
            } else {
        ...
        // case 2: converting first 0 to 1, so that we will get 1 early to form pair
        hm.clear();
        hm.put(1, 0); // putting 0 frequency of 1 at first
        long ans2 = 0;
        ...
        if (firstZeroIndex != -1) {
            ...
            arr[firstZeroIndex] = 0;
        }

        // case 3: converting last 1 to 0, so that we will get more 0 to form pair
        hm.clear();
        hm.put(1, 0); // putting 0 frequency of 1 at first
        long ans3 = 0;
        int lastOneIndex = -1;
