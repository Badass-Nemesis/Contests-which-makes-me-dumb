...
public class B {
     ...
     * 
     * 1 + 2 + 4 + 6 + 9 + 12 + 16 = 50
     * 1+4+9+16 = sum of squares && 2+6+12 = for(n-1 to 1) i*(n-1)
     ...
     * 5 10 15 20 25
     * 
     * 1+4+9+16+25 = sum of sq && 2+6+12+20 = it follows pattern (n^2+n)
     * note -> here n = (n-1)
     * don't know how to calculate it's sum
     */

    public static void solve2() throws IOException {
        Long n = in.nextLong();
        Long ans1 = n * (n + 1) * (2 * n + 1) / 6;
        
        // wrong ans2
        Long ans2 = (n - 1) * (2 + n * n - n) / 2;

        Long ans = ((ans1 + ans2) * 2022) % mod;
    ...
    public static void solve() throws IOException {
        ...
        if (n == 2) {
            ...
            System.out.println(((ans % mod) * 2022) % mod);
        }

        // WRONG CODE BELOW THIS POINT
        //
        // long ans1 = 0;
        ...
        // System.out.println(((ans1 + ans2) * 2022) % mod);
    }
