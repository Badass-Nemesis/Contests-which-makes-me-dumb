...
public class A {
    ...
    public static void solve() throws IOException {
        ...
        // System.out.println(countForward + " " + countBackward); // debug

        if (min != max) {
            System.out.println(2 * countForward * countBackward);
        } else {
            System.out.println(countBackward * (countBackward - 1));
            // System.out.println(n * (n - 1)); // debug
        }
    }
