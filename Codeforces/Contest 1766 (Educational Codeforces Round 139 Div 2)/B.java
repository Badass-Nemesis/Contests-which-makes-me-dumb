...
public class B {
    ...
    public static void solve() throws IOException {
        ...
        while (searchPointer < n - 1 && pointer < n - 2) {
            if (s.charAt(pointer) == s.charAt(searchPointer) && s.charAt(pointer + 1) == s.charAt(searchPointer + 1)) {
                System.out.println("YES");
                return;
            }
            // System.out.println(searchPointer + " " + pointer); // debug

            searchPointer++;

            if (searchPointer == n - 1) {
                // System.out.println(searchPointer + " " + pointer); // debug
                pointer++;
                searchPointer = pointer + 2;
            }
        }
